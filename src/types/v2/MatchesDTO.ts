...
export interface Data {
    ...
    readonly requestingPlayerAttributes: RequestingPlayerAttributes;
    readonly expiryDate: string;
}

export interface Match {
    readonly attributes: MatchAttributes;
...
export interface MatchMetadata {
    ...
    readonly mapModeName: MapModeName;
...
export interface Stats {
    ...
    readonly rankedDelta?: RankedDelta;
}
...
export interface FeatureHitRate1 {
    readonly displayName: FeatureHitRate1DisplayName;
    readonly category: FeatureCriticalRate1CritHitsCategory;
    readonly metadata: AssistsMetadata;
    readonly value: number;
    readonly displayValue: string;
...
export enum FeatureHitRate1DisplayName {
    WebClusterAccuracy = 'Web-Cluster Accuracy'
}
...
export enum FeatureNormalData1DisplayName {
    ...
    GuardianShieldDamageBlocked = 'Guardian Shield Damage Blocked',
    HideAndSeekDistance = 'Hide and Seek Distance',
    LightExplosionAccuracy = 'Light Explosion Accuracy',
    SpectacularSpinKOs = 'Spectacular Spin KOs',
    StoneHaymakerKOs = 'Stone Haymaker KOs'
}
...
export enum FeatureNormalData2DisplayName {
    ClobberinTimeHits = 'Clobberin\' Time Hits',
    FeatureNormalData2 = 'Feature Normal Data 2',
    ItSJeffDevours = 'It\'s Jeff! Devours',
    PsionicVortexHits = 'Psionic Vortex Hits',
    TerrorCapeAccuracy = 'Terror Cape Accuracy'
}
...
export interface Ranked {
    ...
    readonly metadata: RankedMetadata;
    readonly value: number;
    readonly displayValue: string;
...
export interface RankedDelta {
    readonly displayName: string;
    readonly metadata: RankedDeltaMetadata;
    readonly value: number;
    readonly displayValue: string;
    readonly displayType: AssistsDisplayType;
}

export interface RankedDeltaMetadata {
    readonly unit: string;
}
